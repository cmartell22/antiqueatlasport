...
public class ScrollBoxComponent extends Component {
	public static final Identifier ARROW = RoleplayersAtlas.id("textures/gui/arrow.png");
	...
	public void renderArrow(DrawContext context, int mouseX, int mouseY, boolean prev) {
		...
		context.drawTexture(net.minecraft.client.gl.RenderPipelines.GUI_TEXTURED, ARROW, x, y, u, v, ARROW_SIZE, ARROW_SIZE, ARROW_TEXTURE_WIDTH, ARROW_TEXTURE_HEIGHT);
	}
