...
public final class SpawnMarker {
	...
	public static void load(MinecraftClient client) {
		load(folk.sisby.roleplayers_atlas.util.WorldKey.current(client));
	}
	...
	public static void tick(MinecraftClient client) {
		...
		String id = folk.sisby.roleplayers_atlas.util.WorldKey.current(client);
	...
	public static MarkerTexture texture() {
		MarkerTexture found = folk.sisby.roleplayers_atlas.reloader.MarkerTextures.getInstance().asMap().get(iconId());
		if (found != null) return found;
		for (MarkerTexture texture : folk.sisby.roleplayers_atlas.reloader.MarkerTextures.getInstance().asMap().values()) {
