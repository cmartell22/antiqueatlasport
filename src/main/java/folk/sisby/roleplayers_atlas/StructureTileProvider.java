...
public record StructureTileProvider(Identifier id, int priority, Map<ChunkMatcher, List<TileTexture>> matchers) {
	...
	static {
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("center"), ChunkMatcher::center);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("center_above_ground"), ChunkMatcher::aboveGround);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("center_top_above_ground"), ChunkMatcher::topAboveGround);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("center_horizontal"), ChunkMatcher::centerIfHorizontal);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("center_vertical"), ChunkMatcher::centerIfVertical);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("bridge_horizontal"), ChunkMatcher::bridgeHorizontal);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("bridge_vertical"), ChunkMatcher::bridgeVertical);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("path_straight_horizontal"), (ChunkJunctionMatcher) ChunkJunctionMatcher::straightHorizontal);
		CHUNK_MATCHERS.put(RoleplayersAtlas.id("path_straight_vertical"), (ChunkJunctionMatcher) ChunkJunctionMatcher::straightVertical);
	}
}
